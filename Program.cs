...
namespace Assessment_1__Salary_Tracker
{
    ...
    {
        public static string EmailAddress // Public static propert to hold the email address
        {
            get; 
            private set;
        }
        ...
        {
            Console.WriteLine("Welcome to the job agency"); // Display welcome message
            Console.WriteLine("");
            Console.WriteLine("**********************************************************");
            ...
            if (EmailAddress.Contains("@") && EmailAddress.Contains(".ac.uk"))
            {
                Console.WriteLine("");
                secureAccess();
            }
